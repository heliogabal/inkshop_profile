...
if (!function_exists("inkota_shop_form_install_configure_form_alter")) {
  function inkota_shop_form_install_configure_form_alter(&$form, $form_state) {
    $form['site_information']['site_name']['#default_value'] = 'INKOTA Shop';
...
if (!function_exists("system_form_install_select_profile_form_alter")) {
  function system_form_install_select_profile_form_alter(&$form, $form_state) {
    foreach ($form['profile'] as $key => $element) {
      $form['profile'][$key]['#value'] = 'inkota_shop';
    }
  }
}
...
/*function inkota_shop_install_tasks($install_state) {
  ...
  return array(
    'inkota_shop_import_translation' => array(
...
function inkota_shop_install_import_locales(&$install_state) {
